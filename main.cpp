...
int main() {
	...
	std::cout << "just after main()" << std::endl;
	...
	// };
	std::cout << "just before Shader shaderProgram" << std::endl;
...
//	glm::vec3 axisPos = glm::vec3(-0.5f, -0.5f, -0.5f);
	...
	std::cout << "just before Model model" << std::endl;
	Model model("./assets/bunny/scene.gltf");
	std::cout << "just after Model model" << std::endl;
	// Main loop
